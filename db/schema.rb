...
ActiveRecord::Schema[8.1].define(version: 2026_09_03_074117) do
  ...
  create_table "lunch_money_accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.date "sync_start_date"
    t.datetime "updated_at", null: false
    t.index ["lunch_money_item_id", "lunch_money_account_id"], name: "index_lunch_money_accounts_on_item_and_provider_id", unique: true, where: "(lunch_money_account_id IS NOT NULL)"
    t.index ["lunch_money_item_id"], name: "index_lunch_money_accounts_on_lunch_money_item_id"
  end

  create_table "lunch_money_items", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.text "access_token"
    t.datetime "created_at", null: false
    t.uuid "family_id", null: false
    t.string "institution_color"
  ...
  add_foreign_key "lunch_money_accounts", "lunch_money_items"
  add_foreign_key "lunch_money_items", "families"
